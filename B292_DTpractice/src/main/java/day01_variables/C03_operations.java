...
public class C03_operations {
    ...
    public static void main(String[] args) {
        ...
        boolean sonuc2= 5>4 && 7>9 && 6+3 == 9 && 5+2!=8; // tek && baglacında devamına bekmak zorunda degiliz. Hepsi kontrol edilmez.
        System.out.println(sonuc2);//false

        boolean sonuc3=5>4 & 7>9 & 6+3 == 9 & 5+2!=8;  // tek & baglacında devamına bekmak zorundayız. Hepsi kontrol edilir.
